...
contract MyToken is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable {
    ...
    bytes32 public constant CAPCHA_ROLE = keccak256("CAPCHA_ROLE");
    ...
    constructor(string memory name, string memory symbol,uint256 cap_) ERC20(name, symbol) {
        ...
        _setupRole(CAPCHA_ROLE, _msgSender());
    }

    function changeCap(uint256 addcap) public {
         require(hasRole(CAPCHA_ROLE, _msgSender()), "Unauthorized to change cap");
         require(addcap >0,"ERC20CAPPED: cap is 0");
         _cap = addcap; 
